...
MODEL_PARAM = { 
    ...
    "encoder_layers": 3,
    "image_size": 128,
    "output_type": "full", # "full", "only_visual", "only_temporal", "only_textual"
...
CFG = EasyDict()
# General settings
CFG.DESCRIPTION = 'Train ViST on GLA dataset'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN),str(MODEL_PARAM['output_type'])])
)
